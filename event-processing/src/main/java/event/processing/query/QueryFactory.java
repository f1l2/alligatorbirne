...
import event.processing.gen.language.QueryParser.AggregateConditionContext;
import event.processing.gen.language.QueryParser.AggregateFunctionContext;
import event.processing.gen.language.QueryParser.CompositeConditionContext;
import event.processing.gen.language.QueryParser.CompositeOperationDoubleDigitContext;
import event.processing.gen.language.QueryParser.CompositeOperationSingleDigitContext;
import event.processing.gen.language.QueryParser.EvaluationContext;
import event.processing.gen.language.QueryParser.IntValueContext;
import event.processing.gen.language.QueryParser.OperatorContext;
import event.processing.gen.language.QueryParser.PropertyContext;
import event.processing.gen.language.QueryParser.SingleConditionContext;
import event.processing.gen.language.QueryParser.VariableContext;
import event.processing.gen.language.QueryParser.WindowTypeContext;
